...
namespace ConflictCube.ComponentBased.Model.Components.ParticleSystem
{
    public class ParticleSystem : Component
    {
        ...
        private void SpawnParticle()
        {
            ...
            newParticle.AddComponent(new Physics.PhysicsObject(randomVelocity, Vector2.Zero));
        ...
        private void UpdateParticles()
        {
            foreach (Particle particle in Particles)
            {
                ...
                particle.GetComponent<Physics.PhysicsObject>().Velocity = particle.OriginalVelocity * velocityVector;
            }
        }
