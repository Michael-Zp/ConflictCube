...
namespace ConflictCube
{
    public class LevelBuilder
    {
        ...
        public static Level LoadLevel(int levelNumber)
        {
            ...
            newLevel.AddFloor(FloorArea.Left,   FloorLoader.Instance(levelPathLeft,   new Box2D(-1f      , -1f, 21f / 21f, 2f)));
            //newLevel.AddFloor(FloorArea.Middle, FloorLoader.Instance(levelPathMiddle, new Box2D(-1f / 21f, -1f,  2f / 21f, 2f)));
            newLevel.AddFloor(FloorArea.Right,  FloorLoader.Instance(levelPathRight,  new Box2D( 0f / 21f, -1f, 21f / 21f, 2f)));
