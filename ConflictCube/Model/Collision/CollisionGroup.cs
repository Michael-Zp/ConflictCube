...
namespace ConflictCube.Model.Collision
{
    public class CollisionGroup
    {
        ...
        private void CheckCollisions(List<ICollidable> movedObjects)
        {
            foreach(ICollidable obj in movedObjects)
            {
